	...
	case INTERRUPT_SOFTWARE: // System calls
	    ...
	    case WAIT:
		   if ((myTcb = scheduler.getMyTcb()) != null) {
            int myTID = myTcb.getTid();   // get the current thread id
	    ...
	    case EXIT:
		   if ((myTcb = scheduler.getMyTcb()) != null) {
            int myPID = myTcb.getPid();   // get the current thread's parent id
            int myTID = myTcb.getTid();   // get the current thread's id
               
            //check if the current thread is the loader's thread
            if (myPID != -1) {
      ...
      //////////////////////////////////////////////////////////////////
	   //RAWWRITE: Now will be stored in ioQueue to wait rather than using
      //          spin locks
      ////////////////////////////////////////////////////////////////// 
      ...
      //////////////////////////////////////////////////////////////////
	   //SYNC: Now will be stored in ioQueue to wait rather than using
      //      spin locks
      ////////////////////////////////////////////////////////////////// 
